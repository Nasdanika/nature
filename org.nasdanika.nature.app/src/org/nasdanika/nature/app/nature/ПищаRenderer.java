 ...
 * @generated
 */
public interface ПищаRenderer<T extends Пища> extends RendererBase<T> {
	/**
	 * @generated
	 */
	ПищаRenderer<Пища> INSTANCE = new ПищаRenderer<Пища>() {
	};

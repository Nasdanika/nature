 ...
 * @generated
 */
public interface ЛисRenderer<T extends Лис> extends ЗверьRenderer<T> {
	/**
	 * @generated
	 */
	ЛисRenderer<Лис> INSTANCE = new ЛисRenderer<Лис>() {
	};

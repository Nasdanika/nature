...
public class NatureCDOTransactionContextProviderComponent extends CDOTransactionContextProviderComponent<LoginPasswordCredentials> {

	@SuppressWarnings("unchecked")
	@Override
	protected Realm<LoginPasswordCredentials> getSecurityRealm(CDOTransaction view) {
		String resourcePath = "Nature";
